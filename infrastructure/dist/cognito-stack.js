...
class CognitoStack extends cdk.Stack {
    constructor(scope, id, props) {
        ...
        // ============================================================================
        const emailValidationLambda = new lambda.Function(this, 'EmailDomainValidationLambda', {
            runtime: lambda.Runtime.NODEJS_18_X,
            handler: 'index.handler',
            code: lambda.Code.fromAsset(path.join(__dirname, '../lambdas/email-validation')),
        ...
        this.userPool.addTrigger(cognito.UserPoolOperation.PRE_SIGN_UP, emailValidationLambda);
        // ============================================================================
        ...
        // ============================================================================
        const devUserPool = new cognito.UserPool(this, 'UTMMarketplaceDevUserPool', {
        ...
        devUserPool.addTrigger(cognito.UserPoolOperation.PRE_SIGN_UP, emailValidationLambda);
